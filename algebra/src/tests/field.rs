...
pub(crate) fn random_field_tests<F: Field>(type_name: String) {
    ...
    random_conversion_test::<F, _>(&mut rng, type_name);
...
fn random_conversion_test<F: Field, R: RngCore>(mut rng: R, type_name: String) {
