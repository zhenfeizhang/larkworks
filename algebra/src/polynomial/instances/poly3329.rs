use crate::{ZZpConfig3329, ZZpX, ZZpXConfig};

/// Configuration for ZZ[x]/(x^256+1) mod 3329
#[derive(Copy, Clone, Debug, Default, PartialEq, Eq)]
pub struct ZZpXConfig3329_256;

impl ZZpXConfig for ZZpXConfig3329_256 {
    /// Config for the base field
    type BaseConfig = ZZpConfig3329;
    /// Number of coefficients in a poly
    const DIM: usize = 256;
}

/// Polynomial used in Kyber with coefficient from ZZ_q where q=3329.
pub type Poly3329_256 = ZZpX<ZZpXConfig3329_256>;

#[test]
fn test_poly() {
    use crate::F3329;
    let coeffs = (0..ZZpXConfig3329_256::DIM)
